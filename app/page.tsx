...
const galleryImages = [
  ...
  },
  {
    ...
    alt: "Producto servido en Orlan Café",
    width: 800,
    height: 800,
    aspect: "aspect-[1/1]",
  },
  ...
  },
  {
    ...
    alt: "Interior del local Orlan Café",
    width: 800,
    height: 1000,
    aspect: "aspect-[4/5]",
  },
...
function HighlightCard({
  ...
  return (
    ...
    >
      <div className="mb-5 inline-flex h-11 w-11 items-center justify-center rounded-full bg-[#f8f2e8] text-[#bfa05d]">
        <Icon size={20} />
      </div>
...
export default function Home() {
      ...
      <section className="px-6 pb-12 pt-32 md:pb-16 md:pt-28">
        <div className="mx-auto max-w-6xl text-center">
          <motion.div variants={fadeUp} initial="hidden" animate="show">
            <p className="mb-5 text-[11px] uppercase tracking-[0.38em] text-[#bfa05d] md:text-xs">
              Café · Pastelería · Rosario
            </p>

            <h1 className="mb-6 font-orlan-3d text-6xl md:text-8xl">
              ORLAN CAFÉ
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/carta"
                className="inline-flex items-center gap-2 rounded-full bg-[#bfa05d] px-7 py-3 text-sm font-medium text-white transition duration-300 hover:bg-[#a88c4e]"
              >
                Ver carta
                <ArrowRight size={16} />
              </Link>
              ...
              <Link
                href="/contacto"
                className="inline-flex items-center gap-2 rounded-full border border-[#e6d8c5] px-7 py-3 text-sm font-medium text-[#2b211c] transition duration-300 hover:bg-[#bfa05d] hover:text-white"
              >
                Cómo llegar
              </Link>
            </div>
          ...
          >
            <div className="relative aspect-[4/5] w-full overflow-hidden">
              <Image
                ...
                alt="Mesa con café servido en Orlan Café"
                width={1000}
                height={1200}
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              ...
              <p className="leading-8 text-[#6f5d52]">
                En Orlan conviven café de especialidad, pastelería y una
  ...
  {reviewImages.map((review, index) => (
    <motion.div
      ...
      className="overflow-hidden rounded-[28px] border border-[#eee6df] bg-white shadow-[0_14px_40px_rgba(43,33,28,0.06)]"
    >
      <Image
        src={review.src}
        alt={review.alt}
...
<motion.div
  ...
  whileInView="show"
  viewport={{ once: true }}
  className="mt-12 text-center text-sm text-[#bfa05d]"
>
  ⭐ 4.5 en Google · Opiniones verificadas
</motion.div>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-xl leading-7 text-[#6f5d52]">
              Visitá nuestro local y disfrutá la experiencia Orlan en un espacio
              pensado para vos.
            </p>
          </motion.div>
          ...
          >
            <div className="mb-4 flex justify-center text-[#bfa05d]">
              <MapPin size={20} />
            </div>

            <p className="mb-2 text-sm uppercase tracking-[0.2em] text-[#bfa05d]">
              Rosario
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/contacto"
                className="rounded-full bg-[#bfa05d] px-6 py-2 text-sm text-white transition hover:bg-[#a88c4e]"
              >
                Cómo llegar
              </Link>
            </div>
